(function() {
    ...
    */
    ...
    function wa(a) {
        ...
        (b = a.j = a.j || b) ? b.Ra ? a.h = a.v || a.m : void 0 != b.o && a.m < b.o ? (a.h = b.o, a.j = null) : a.h = a.m: a.h = 0
    }
    ...
    function za(a, b, c, d) {
        try {
            ...
            return a.h.l = null, ra(a.h, g), Aa(a)
        }
        a.h.l = null;
        d.call(a.h, f);
        return Aa(a)
    ...
    function Ba(a) {
        this.next = function(b) {
            qa(a.h);
            a.h.l ? b = za(a, a.h.l.next, b, a.h.A) : (a.h.A(b), b = Aa(a));
            return b
        };
        this.throw = function(b) {
            qa(a.h);
            a.h.l ? b = za(a, a.h.l["throw"], b, a.h.A) : (ra(a.h, b), b = Aa(a));
            return b
        };
    ...
    t("Promise", function(a) {
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), n = l.next(); !n.done; n = l.next()) d(n.value).na(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, n) {
                ...
                var q = [],
                    p = 0;
                do q.push(void 0), p++, d(k.value).na(r(q.length - 1), n), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    t("WeakMap", function(a) {
        ...
        b.prototype.set = function(k, l) {
            ...
            e(k);
            if (!Ea(k, g)) throw Error("WeakMap key fail: " + k);
            k[g][this.h] = l;
            return this
        };
        b.prototype.get = function(k) {
            return d(k) && Ea(k, g) ? k[g][this.h] : void 0
        };
        b.prototype.has = function(k) {
            return d(k) && Ea(k, g) && Ea(k[g], this.h)
        };
        b.prototype.delete = function(k) {
            return d(k) && Ea(k, g) && Ea(k[g], this.h) ? delete k[g][this.h] : !1
        };
        return b
    });
    t("Map", function(a) {
    ...
    var Xb = E("Opera"),
        Yb = E("Trident") || E("MSIE"),
        Zb = E("Edge"),
        $b = E("Gecko") && !(-1 != Fb().toLowerCase().indexOf("webkit") && !E("Edge")) && !(E("Trident") || E("MSIE")) && !E("Edge"),
        ac = -1 != Fb().toLowerCase().indexOf("webkit") && !E("Edge");
    ...
    if (A.document && Yb) {
        var jc = bc();
        hc = jc ? jc : parseInt(gc, 10) || void 0
    } else hc = void 0;
    var kc = hc;
    var lc = Vb() || E("iPod"),
        mc = E("iPad");
    !E("Android") || Gb();
    Gb();
    var nc = E("Safari") && !(Gb() || E("Coast") || E("Opera") || E("Edge") || E("Edg/") || E("OPR") || E("Firefox") || E("FxiOS") || E("Silk") || E("Android")) && !(Vb() || E("iPad") || E("iPod"));
    var oc = {},
        pc = null;
    ...
    var uc = "function" === typeof Uint8Array;
    var vc = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol(void 0) : void 0;

    function wc(a, b) {
        Object.isFrozen(a) || (vc ? a[vc] |= b : void 0 !== a.ra ? a.ra |= b : Object.defineProperties(a, {
            ra: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function zc(a) {
        return Array.isArray(a) ? !!(xc(a) & 2) : !1
    }
    ...
    var Cc, Dc = Object.freeze(yc([]));

    function Ec(a) {
        if (zc(a.C)) throw Error("Cannot mutate an immutable Message");
    }
    var Fc = "undefined" != typeof Symbol && "undefined" != typeof Symbol.hasInstance;
    ...
    function Ic(a, b, c, d) {
        ...
        var e = Hc(a, b, d);
        null == e && (e = Dc);
        if (zc(a.C)) c && (Ac(e), Object.freeze(e));
        else if (e === Dc || zc(e)) e = yc(e.slice()), G(a, b, e, d);
        return e
    }

    function Jc(a, b, c, d) {
        Ec(a);
        (c = Kc(a, c)) && c !== b && null != d && (a.h && c in a.h && (a.h[c] = void 0), G(a, c, void 0));
        return G(a, b, d)
    }
    ...
    function Kc(a, b) {
        for (var c = 0, d = 0; d < b.length; d++) {
            var e = b[d];
            null != Hc(a, e) && (0 !== c && G(a, c, void 0, !1, !0), c = e)
        }
        return c
    }
    ...
    function Mc(a, b, c, d) {
        ...
        if (!f) {
            ...
            f = [];
            e = e || zc(d);
            for (var g = 0; g < d.length; g++) f[g] = new b(d[g]), e && Ac(f[g].C);
            e && (Ac(f), Object.freeze(f));
            a.h[c] = f
        }
        return f
    }
    ...
    function Qc(a) {
        switch (typeof a) {
            ...
            case "object":
                if (a && !Array.isArray(a) && uc && null != a && a instanceof Uint8Array) return qc(a)
        }
        return a
    };
    ...
    function Uc(a, b) {
        if (null != a) {
            if (Array.isArray(a)) a = Tc(a, b);
            else if (Bc(a)) {
                var c = {},
                    d;
                for (d in a) c[d] = Uc(a[d], b);
                a = c
            } else a = b(a);
            return a
        }
    ...
    function Tc(a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = Uc(c[d], b);
        Array.isArray(a) && xc(a) & 1 && yc(c);
        return c
    }
    ...
    function Vc(a) {
        ...
        a = Qc(a);
        return Array.isArray(a) ? Rc(a, Vc) : a
    }

    function Sc(a) {
        return uc && null != a && a instanceof Uint8Array ? new Uint8Array(a) : a
    };
    ...
    function Xc(a, b, c) {
        ...
        if (c)
            for (b = 0; b < c.length; b++)
                if (a = c[b], a < this.l) a += this.j, (d = this.C[a]) ? Array.isArray(d) && yc(d) : this.C[a] = Dc;
                else {
    ...
    function Zc(a) {
        Cc = !0;
        try {
            return JSON.stringify(a.toJSON(), $c)
        } finally {
            Cc = !1
        }
    }
        ...
        if (c) {
            ...
            for (var d in c) {
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length)
                            for (f = Mc(a, e[0].constructor, g, f), g = 0; g < Math.min(f.length, e.length); g++) ad(f[g], e[g])
                    } else(f = Lc(a, e.constructor, g, void 0, f)) && ad(f, e)
                }
            }
        }
    }
    ...
    if (Fc) {
        var cd = {};
        Object.defineProperties(bd, (cd[Symbol.hasInstance] = Gc(function() {
    ...
    if (Fc) {
        var ed = {};
        Object.defineProperties(I, (ed[Symbol.hasInstance] = Gc(Object[Symbol.hasInstance]), ed))
    };
    var fd = window;
    vb("csi.gstatic.com");
    vb("googleads.g.doubleclick.net");
    vb("partner.googleadservices.com");
    vb("pubads.g.doubleclick.net");
    vb("securepubads.g.doubleclick.net");
    vb("tpc.googlesyndication.com");
    /*
    ...
    */
    ...
    var kd = {
            vb: "allow-forms",
            wb: "allow-modals",
            xb: "allow-orientation-lock",
            yb: "allow-pointer-lock",
            zb: "allow-popups",
            Ab: "allow-popups-to-escape-sandbox",
            Bb: "allow-presentation",
            Cb: "allow-same-origin",
            Db: "allow-scripts",
    ...
    function rd() {
        ...
        function b(r) {
            for (var q = g, p = 0; 64 > p; p += 4) q[p / 4] = r[p] << 24 | r[p + 1] << 16 | r[p + 2] << 8 | r[p + 3];
            for (p = 16; 80 > p; p++) r = q[p - 3] ^ q[p - 8] ^ q[p - 14] ^ q[p - 16], q[p] = (r << 1 | r >>> 31) & 4294967295;
            r = e[0];
            var z = e[1],
                y = e[2],
                F = e[3],
            ...
            for (p = 0; 80 > p; p++) {
                if (40 > p)
                    if (20 > p) {
                        var J = F ^ z & (y ^ F);
                        var O = 1518500249
                    } else J = z ^ y ^ F, O = 1859775393;
                else 60 > p ? (J = z & y | F & (z | y), O = 2400959708) : (J = z ^ y ^ F, O = 3395469782);
                J = ((r << 5 | r >>> 27) & 4294967295) + J + M + O + q[p] & 4294967295;
                M = F;
                F = y;
                y = (z << 30 | z >>> 2) & 4294967295;
                z = r;
                r = J
            }
        ...
        function c(r, q) {
            if ("string" === typeof r) {
                ...
                for (var p = [], z = 0, y = r.length; z < y; ++z) p.push(r.charCodeAt(z));
                r = p
            }
            q || (q = r.length);
            p = 0;
            if (0 == l)
                for (; p + 64 < q;) b(r.slice(p, p + 64)), p += 64, n += 64;
            for (; p < q;)
                if (f[l++] = r[p++], n++, 64 == l)
                    for (l = 0, b(f); p + 64 < q;) b(r.slice(p, p + 64)), p += 64, n += 64
        }
        ...
        function d() {
            ...
            b(f);
            for (p = q = 0; 5 > p; p++)
                for (var z = 24; 0 <= z; z -= 8) r[q++] = e[p] >> z & 255;
            return r
        }
        ...
        return {
            ...
            digest: d,
            ib: function() {
                for (var r = d(), q = "", p = 0; p < r.length; p++) q += "0123456789ABCDEF".charAt(Math.floor(r[p] / 16)) + "0123456789ABCDEF".charAt(r[p] % 16);
                return q
            }
        }
    };
    ...
    m.clear = function() {
        for (var a = (this.h.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = xb(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    function Dd(a) {
        ...
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new zd(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? sd(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && Bd(b) && ((b = Cd("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = Cd("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    function Ed(a) {
        if (Fc) {
            var b = {};
            Object.defineProperties(a, (b[Symbol.hasInstance] = Gc(Object[Symbol.hasInstance]), b))
        }
    };
    ...
    function Ud(a, b) {
        var c = b.type;
        c in a.listeners && bb(a.listeners[c], b) && (Rd(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--))
    }
    ...
    function Yd(a, b, c, d, e) {
        ...
        else c = $d(c), a && a[Od] ? a.R(b, c, Na(d) ? !!d.capture : !!d, e) : ae(a, b, c, !1, d, e)
    }
    ...
    function Zd(a, b, c, d, e) {
        ...
        else c = $d(c), a && a[Od] ? a.j.add(String(b), c, !0, Na(d) ? !!d.capture : !!d, e) : ae(a, b, c, !0, d, e)
    }

    function fe(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) fe(a, b[f], c, d, e);
        else(d = Na(d) ? !!d.capture : !!d, c = $d(c), a && a[Od]) ? a.j.remove(String(b), c, d, e) : a && (a = be(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = Td(b, c, d, e)), (c = -1 < a ? b[a] : null) && ge(c))
    }
    ...
    function ie(a, b) {
        ...
        a = a.xa;
        c = b.type || b;
        "string" === typeof b ? b = new Gd(b, a) : b instanceof Gd ? b.target = b.target || a : (e = b, b = new Gd(c, a), sb(b, e));
        e = !0;
        if (d)
    ...
    K.prototype.R = function(a, b, c, d) {
    ...
    function ke(a) {
        ...
        var d = this;
        this.A = this.i = 0;
        this.J = null !== a && void 0 !== a ? a : {
            L: function(e, f) {
                return setTimeout(e, f)
            },
            Y: clearTimeout
        };
        this.h = null !== (c = null === (b = window.navigator) || void 0 === b ? void 0 : b.onLine) && void 0 !== c ? c : !0;
        this.m = function() {
            return x(function(e) {
                return w(e, le(d), 0)
            })
    ...
    function me(a) {
        a.A = a.J.L(function() {
            var b;
            return x(function(c) {
                if (1 == c.h) return a.h ? (null === (b = window.navigator) || void 0 === b ? 0 : b.onLine) ? c.o(3) : w(c, le(a), 3) : w(c, le(a), 3);
                me(a);
                c.h = 0
            })
        }, 3E4)
    ...
    function le(a, b) {
        return a.u ? a.u : a.u = new Promise(function(c) {
            ...
            return x(function(g) {
                switch (g.h) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, e = null === d || void 0 === d ? void 0 : d.signal, f = !1, sa(g, 2, 3), d && (a.i = a.J.L(function() {
                            d.abort()
                    ...
                    case 3:
                        ...
                        a.u = void 0;
                        a.i && (a.J.Y(a.i), a.i = 0);
                        f !== a.h && (a.h = f, a.h ? ie(a, "networkstatus-online") : ie(a, "networkstatus-offline"));
                        c(f);
                        wa(g);
                        break;
                    case 2:
    ...
    function qe(a) {
        -1 == a.h && (a.h = ab(a.data_, function(b, c, d) {
    ...
    He.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.blockSize, d = 0, e = this.m, f = this.i; d < b;) {
                if (0 == f)
                    for (; d <= c;) Ie(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    var Je = "StopIteration" in A ? A.StopIteration : {
    ...
    function Pe(a) {
        if (a instanceof Qe || a instanceof Re || a instanceof Se) return a;
        if ("function" == typeof a.next) return new Qe(function() {
            return a
        });
        if ("function" == typeof a[Symbol.iterator]) return new Qe(function() {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.K) return new Qe(function() {
            return a.K()
        });
    ...
    function Te(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Te)
                for (c = Ue(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    m.delete = function(a) {
        return We(this.i, a) ? (delete this.i[a], --this.size, this.j++, this.h.length > 2 * this.size && Ve(this), !0) : !1
    };
    ...
    function Ve(a) {
        ...
        if (a.size != a.h.length) {
            var e = {};
            for (c = b = 0; b < a.h.length;) d = a.h[b], We(e, d) || (a.h[c++] = d, e[d] = 1), b++;
            a.h.length = c
        }
    }
    m.get = function(a, b) {
        return We(this.i, a) ? this.i[a] : b
    };
    m.set = function(a, b) {
        We(this.i, a) || (this.size += 1, this.h.push(a), this.j++);
        this.i[a] = b
    };
    m.forEach = function(a, b) {
        for (var c = Ue(this), d = 0; d < c.length; d++) {
            var e = c[d],
                f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    m.keys = function() {
        return Pe(this.K(!0)).j()
    };
    m.values = function() {
        return Pe(this.K(!1)).j()
    };
    m.entries = function() {
        var a = this;
        return Fe(this.keys(), function(b) {
            return [b, a.get(b)]
        })
    };
    m.K = function(a) {
        ...
        if (0 == a.h)
            if (a.j) {
                ...
                if (c.i) {
                    ...
                    e && (0 == c.h && 1 == d ? gf(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : hf(c), jf(c, e, 3, b)))
                }
                a.j = null
            } else af(a, 3, b)
    }
    ...
    function af(a, b, c) {
        if (0 == a.h) {
            ...
            g || (a.u = c, a.h = b, a.j = null, lf(a), 3 != b || c instanceof ff || nf(a, c))
        }
    }
    ...
    $e.prototype.A = function() {
        for (var a; a = hf(this);) jf(this, a, this.h, this.u);
        this.v = !1
    };
    ...
    function jf(a, b, c, d) {
        ...
        if (b.h) b.h.j = null, of (b, c, d);
        else try {
            b.j ? b.i.call(b.context) : of (b, c, d)
        } catch (e) {
            pf.call(null, e)
        }
        se(cf, b)
    ...
    m.ka = function(a) {
        ...
        if (b) {
            var c = this.i[b];
            0 != this.m ? (this.j.push(a), this.h[a + 1] = Ka) : (c && bb(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2])
        }
        return !!b
    };
    m.ca = function(a, b) {
    ...
    tf.prototype.set = function(a, b) {
        void 0 === b ? this.h.remove(a) : this.h.set(a, Ye(b))
    };
    ...
    uf.prototype.set = function(a, b) {
        uf.N.set.call(this, a, Tf(b))
    };
    uf.prototype.i = function(a) {
        a = uf.N.get.call(this, a);
    ...
    Uf.prototype.set = function(a, b, c) {
        ...
        Uf.N.set.call(this, a, b)
    };
    Uf.prototype.i = function(a) {
        var b = Uf.N.i.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
    ...
    function Zf(a, b) {
        ...
        this.h = null;
        var c;
        if (c = Yb) c = !(9 <= Number(kc));
        if (c) {
            $f || ($f = new Te);
            this.h = $f.get(a);
            this.h || (b ? this.h = document.getElementById(b) : (this.h = document.createElement("userdata"), this.h.addBehavior("#default#userData"), document.body.appendChild(this.h)), $f.set(a, this.h));
            try {
                this.h.load(this.i)
            } catch (d) {
                this.h = null
    ...
    m.set = function(a, b) {
        this.h.setAttribute(bg(a), b);
        cg(this)
    };
    m.get = function(a) {
        a = this.h.getAttribute(bg(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    m.remove = function(a) {
        this.h.removeAttribute(bg(a));
        cg(this)
    };
    m.K = function(a) {
        var b = 0,
        ...
        d.next = function() {
            if (b >= c.length) return Me;
            var f = c[b++];
            if (a) return Ne(decodeURIComponent(f.nodeName.replace(/\./g, "%")).substr(1));
            f = f.nodeValue;
            if ("string" !== typeof f) throw "Storage mechanism: Invalid value was encountered";
            return Ne(f)
        };
    ...
    dg.prototype.K = function(a) {
        ...
        d.next = function() {
            var f = b.next();
            if (f.done) return f;
            for (f = f.value; f.substr(0, c.h.length) != c.h;) {
                f = b.next();
                if (f.done) return f;
                f = f.value
            }
            return Ne(a ? f.substr(c.h.length) : c.i.get(f))
        };
        var e = d.next;
        d.h = function() {
            return Oe(e.call(d))
    ...
    eg.prototype.W = function() {
        return Hc(this, 2 === Kc(this, fg) ? 2 : -1)
    };
    eg.prototype.setValue = function(a) {
        return Jc(this, 2, fg, a)
    };
    var fg = [2, 3, 4, 5, 6];
    ...
    v(jg, I);
    jg.prototype.getPlayerType = function() {
        return Hc(this, 36)
    };
    jg.prototype.setHomeGroupInfo = function(a) {
        return H(this, 81, a)
    };
    var kg = [9, 66, 24, 32, 86, 100, 101];
    ...
    v(ng, I);
    ng.prototype.setToken = function(a) {
        return G(this, 2, a)
    };
    ...
    v(og, I);
    og.prototype.setSafetyMode = function(a) {
        return G(this, 5, a)
    };
    var pg = [12];
    ...
    ug.prototype.setValue = function(a) {
        return G(this, 2, a)
    };
    var tg = [4, 5];
    ...
    var Hg = [23, 24, 11, 6, 7, 5, 2, 3, 20, 21, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 157, 158, 159, 163, 164, 168, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 198, 199, 200, 201, 203, 204, 205, 206, 258, 259, 260, 261, 209, 226, 227, 232, 233, 234, 240, 247, 248, 251, 254, 255, 270, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 337, 338, 340, 344, 348, 350, 351, 352, 353, 354, 355, 356, 357, 358, 361, 363, 364, 368, 369, 370, 373, 374, 375,
        378, 380, 381, 388, 389, 403, 412, 413, 414, 415, 416, 417, 418, 419, 420, 423, 424, 425, 426, 427, 117
    ];
    ...
    v(Jg, I);
    Jg.prototype.setVideoId = function(a) {
        return Jc(this, 1, Kg, a)
    };
    Jg.prototype.getPlaylistId = function() {
        return Hc(this, 2 === Kc(this, Kg) ? 2 : -1)
    };
    var Kg = [1, 2];
    ...
    v(Qg, Og);
    Ed(Qg);
    var Rg, Sg, Tg, Ug = A.window,
        Vg = (null === (Rg = null === Ug || void 0 === Ug ? void 0 : Ug.yt) || void 0 === Rg ? void 0 : Rg.config_) || (null === (Sg = null === Ug || void 0 === Ug ? void 0 : Ug.ytcfg) || void 0 === Sg ? void 0 : Sg.data_) || {},
        Wg = (null === (Tg = null === Ug || void 0 === Ug ? void 0 : Ug.ytcfg) || void 0 === Tg ? void 0 : Tg.obfuscatedData_) || [];
    ...
    Ed(Xg);
    var Yg = new Xg(Wg),
        Zg = Vg.EXPERIMENT_FLAGS;
    if (!Zg || !Zg.jspb_i18n_extension) {
        var $g = new Qg;
        Pg.i(Yg, $g)
    }
    C("yt.config_", Vg);
    ...
    function ah() {
        var a = arguments;
        1 < a.length ? Vg[a[0]] = a[1] : 1 === a.length && Object.assign(Vg, a[0])
    }

    function N(a, b) {
        return a in Vg ? Vg[a] : b
    }
    ...
    function gh(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = N("ERRORS", []), e.push([a, "ERROR", b, c, d]), ah("ERRORS", e));
        eh(a)
    }

    function hh(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = N("ERRORS", []), e.push([a, "WARNING", b, c, d]), ah("ERRORS", e))
    };
    var ih = 0;
    ...
    function kh(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in jh || (this[b] = a[b]);
                this.scale = a.scale;
    ...
    kh.prototype.stopImmediatePropagation = function() {
        this.event && (this.event.cancelBubble = !0, this.event.stopImmediatePropagation && this.event.stopImmediatePropagation())
    };
    var ib = A.ytEventsEventsListeners || {};
    C("ytEventsEventsListeners", ib);
    var lh = A.ytEventsEventsCounter || {
        count: 0
    };
    C("ytEventsEventsCounter", lh);
        ...
        a && ("string" == typeof a && (a = [a]), D(a, function(b) {
            if (b in ib) {
                var c = ib[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? oh() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete ib[b]
            }
        }))
    }
    ...
    function ph(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                g = fh(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), oh() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                ib[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function uh(a, b) {
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                var g = vh(f[0] || ""),
                    h = vh(f[1] || "");
                g in c ? Array.isArray(c[g]) ? eb(c[g], h) : c[g] = [c[g], h] : c[g] = h
            } catch (r) {
                var k = r,
                    l = f[0],
                    n = String(uh);
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: wh == n ? "unchanged" : n
                }];
                th.hasOwnProperty(l) || hh(k)
            }
        }
        return c
    }
    ...
    function Ah(a) {
        ...
        var c = a.match(Jb)[1] || null,
            d = Lb(a);
        c && d ? (a = a.match(Jb), b = b.match(Jb), a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? Lb(b) == d && (Number(b.match(Jb)[4] || null) || null) == (Number(a.match(Jb)[4] || null) || null) : !0;
        return a
    }

    function vh(a) {
        return a && a.match(sh) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    var Eh = {
        Kb: "WEB_DISPLAY_MODE_UNKNOWN",
        Gb: "WEB_DISPLAY_MODE_BROWSER",
        Ib: "WEB_DISPLAY_MODE_MINIMAL_UI",
        Jb: "WEB_DISPLAY_MODE_STANDALONE",
    ...
    function Jh(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : qh(a, c || 0)
    }
    Lh.prototype.Y = function(a) {
    ...
    function Oh(a) {
        ...
        try {
            ...
            var r;
            e.u_aw =
                null == (r = fd.screen) ? void 0 : r.availWidth;
            var q;
            e.u_cd = null == (q = fd.screen) ? void 0 : q.colorDepth
        } catch (ka) {}
        h = b.h;
        try {
            var p = h.screenX;
        ...
        try {
            M = h.innerWidth, J = h.innerHeight
        } catch (ka) {}
        try {
            var ic = h.screen.availWidth;
            var Ke = h.screen.availTop
        } catch (ka) {}
        p = [O, fb, p, z, ic, Ke, y, F, M, J];
        z = b.h.top;
        try {
            var Z = (z || window).document,
                S =
                "CSS1Compat" == Z.compatMode ? Z.documentElement : Z.body;
            var U = (new gd(S.clientWidth, S.clientHeight)).round()
        } catch (ka) {
            U = new gd(-12245933, -12245933)
        }
        Z = U;
        U = {};
        var V = void 0 === V ? A : V;
        S = new pe;
        V.SVGElement && V.document.createElementNS && S.set(0);
        z = nd();
        z["allow-top-navigation-by-user-activation"] && S.set(1);
        z["allow-popups-to-escape-sandbox"] && S.set(2);
        V.crypto && V.crypto.subtle && S.set(3);
        V.TextDecoder && V.TextEncoder && S.set(4);
        V = qe(S);
        U.bc = V;
        U.bih = Z.height;
        U.biw = Z.width;
        ...
        b = (U.vis = b.prerendering ?
            3 : {
                ...
                preview: 4,
                unloaded: 5
            }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, U.wgl = !!fd.WebGLRenderingContext, U);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var Qh = "XMLHttpRequest" in A ? function() {
    ...
    function Vh(a, b) {
        ...
        for (e in Sh) {
            var f = N(Sh[e]);
            !f || !c && Lb(a) || d && void 0 !== b[e] || (b[e] = f)
        }
        if (c || !Lb(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        if (c || !Lb(a)) {
            try {
        ...
        if (c || !Lb(a)) b["X-YouTube-Ad-Signals"] = xh(Oh(void 0));
        return b
    }
    ...
    function Wh(a) {
        var b = window.location.search,
            c = Lb(a);
        P("debug_handle_relative_url_for_query_forward_killswitch") || c || !Ah(a) || (c = document.location.hostname);
        var d = Kb(a.match(Jb)[5] || null);
        ...
        var d = Zh(a, b),
            ...
            f = $h(a, function(k) {
                if (!e) {
                    ...
                    if (l || r || q) n = ai(a, c, k, b.convertToSafeHtml);
                    ...
                    n = n || {};
                    r = b.context || A;
                    l ? b.onSuccess && b.onSuccess.call(r, k, n) : b.onError && b.onError.call(r, k, n);
                    b.onFinish && b.onFinish.call(r, k, n)
                }
    ...
    function Yh(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = zh(a, b || {}, !0);
        return a
    }
    ...
    function Zh(a, b) {
        ...
        b.excludeXsrf || Lb(a) && !b.withCredentials && Lb(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = yh(e), sb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Ob(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            a = !f
        }!Uh && a && "POST" != b.method && (Uh = !0, gh(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, hh(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? bi(a) : null) e = {}, D(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = ci(g)
                })
        }
        d && di(e);
    ...
    function di(a) {
        if (Na(a))
            for (var b in a) {
                ...
                if (c) {
                    c = b;
                    vb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");
                    var d = a[b];
                    if (void 0 === tb) {
                        var e = null;
    ...
    function $h(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && fh(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = Rh();
        ...
        P("debug_forward_web_query_parameters") && (a = Wh(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    var ei = A.ytPubsubPubsubInstance || new L,
        fi = A.ytPubsubPubsubSubscribedKeys || {},
    ...
    C("ytPubsubPubsubInstance", ei);
    C("ytPubsubPubsubTopicToKeys", gi);
    C("ytPubsubPubsubIsSynchronous", hi);
    C("ytPubsubPubsubSubscribedKeys", fi);
    ...
    var ki = Ch("initial_gel_batch_timeout", 2E3),
        li = Math.pow(2, 16) - 1,
        mi = void 0;
    ...
    var oi = new ni,
        pi = new ni,
        qi = !0,
        ri = A.ytLoggingTransportGELQueue_ || new Map;
    C("ytLoggingTransportGELQueue_", ri);
    var si = A.ytLoggingTransportGELProtoQueue_ || new Map;
    C("ytLoggingTransportGELProtoQueue_", si);
    var ti = A.ytLoggingTransportTokensToCttTargetIds_ || {};
    C("ytLoggingTransportTokensToCttTargetIds_", ti);
    var ui = A.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    C("ytLoggingTransportTokensToJspbCttTargetIds_", ui);
    ...
    function xi(a, b, c, d) {
        d = void 0 === d ? !1 : d;
        a && (mi = new a);
        a = Ch("tvhtml5_logging_max_batch") || Ch("web_logging_max_batch") || 100;
        var e = Q(),
            f = d ? pi.j : oi.j;
        b.length >= a ? zi({
            writeThenSend: !0
        }, P("flush_only_full_queue") ? c : void 0, d) : 10 <= e - f && (Ai(d), d ? pi.j = e : oi.j = e)
    }
    ...
    function Di(a, b) {
        if ("log_event" === a.endpoint) {
            var c = wi(a, !0),
                d = new Map;
            d.set(c, [Zc(a.payload)]);
            b && (mi = new b);
            return new $e(function(e) {
                mi && mi.isReady() ? Ei(d, e, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function wi(a, b) {
        ...
        if (a.da) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                c = a.P;
                var d = new Jg;
                c.videoId ? d.setVideoId(c.videoId) : c.playlistId && Jc(d, 2, Kg, c.playlistId);
                ui[b] = d
            } else b = a.P, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), ti[a.P.token] = c;
            c = a.P.token
        }
        return c
    }
    ...
    function zi(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new $e(function(d) {
            c ? (window.clearTimeout(pi.i), window.clearTimeout(pi.h), pi.h = 0) : (window.clearTimeout(oi.i), window.clearTimeout(oi.h), oi.h = 0);
            if (mi && mi.isReady())
                if (void 0 !== b)
                    if (c) {
                        var e = new Map,
                        ...
                        Ei(e, d, a);
                        si.delete(b)
                    } else e = new Map, f = ri.get(b) || [], e.set(b, f), Ci(e, d, a), ri.delete(b);
            else c ? (Ei(si, d, a), si.clear()) : (Ci(ri, d, a), ri.clear());
            else Ai(c), d()
        })
    }
    ...
    function Ai(a) {
        a = void 0 === a ? !1 : a;
        if (P("web_gel_timeout_cap") && (!a && !oi.h || a && !pi.h)) {
            var b = qh(function() {
                zi({
                    writeThenSend: !0
                }, void 0, a)
        ...
        window.clearTimeout(a ? pi.i : oi.i);
        b = N("LOGGING_BATCH_TIMEOUT", Ch("web_gel_debounce_ms", 1E4));
        P("shorten_initial_gel_batch_timeout") && qi && (b = ki);
        b = qh(function() {
            zi({
                writeThenSend: !0
            }, void 0, a)
    ...
    function Ci(a, b, c, d) {
        ...
        for (var h = a.next(); !h.done; h = a.next()) {
            ...
            Ii(k, f, h);
            Ji(c);
            Ki(e, "log_event", k, Li(c, h, function() {
                g--;
                g || b()
            }, function() {
                g--;
    ...
    function Ei(a, b, c, d) {
        ...
        for (var h = a.next(); !h.done; h = a.next()) {
            ...
            var l = k = k.next().value;
            k = new Lg;
            var n = Mi(e.config_ || Gi());
            H(k, 1, n);
            l = Ni(l);
            for (n = 0; n < l.length; n++) Oc(k, 3, Gg, l[n]);
            (l = ui[h]) && Oi(k, h, l);
            delete ui[h];
            h = "visitorOnlyApprovedKey" === h;
            Pi(k, f, h);
    ...
    function Ii(a, b, c) {
        ...
        !c && (b = N("EVENT_ID", void 0)) && (c = Qi(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function Qi() {
        var a = N("BATCH_CLIENT_COUNTER", void 0) || 0;
        a || (a = Math.floor(Math.random() * li / 2));
        a++;
        a > li && (a = 1);
        ah("BATCH_CLIENT_COUNTER", a);
        return a
    }
    ...
    function Ni(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            if (null == f || "" == f) var h = new g;
                ...
                var k = JSON.parse(f);
                Array.isArray(k) || Wc(Error("Expected to deserialize an Array but got " + La(k) + ": " + k));
                Yc = k;
                var l = new g(k);
                Yc = null;
                h = l
            ...
            gh(new ii("Transport failed to deserialize " + String(a[c])))
        }
        return b
    };
    var Ri = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", Ri);

    function Si(a) {
        Ri[a] = a in Ri ? Ri[a] + 1 : 0;
        return Ri[a]
    };
    ...
    function $i() {
        return "INNERTUBE_API_KEY" in Vg && "INNERTUBE_API_VERSION" in Vg
    }
    ...
    function Gi() {
        return {
            ...
            Aa: N("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            Ba: N("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            lb: N("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
            ...
            mb: N("INNERTUBE_HOST_OVERRIDE", void 0) || "",
            ob: !!N("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            nb: !!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function Fi(a) {
        ...
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = u(Object.entries(yh(N("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = u(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function Mi(a) {
        ...
        dj(a, c);
        ej(c);
        N("DELEGATED_SESSION_ID") && !P("pageid_as_header_web") && (a = new og, G(a, 3, N("DELEGATED_SESSION_ID")));
        a = u(Object.entries(yh(N("DEVICE", ""))));
        for (d = a.next(); !d.done; d = a.next()) e = u(d.value), d = e.next().value, e = e.next().value, "cbrand" === d ? G(c, 12, e) : "cmodel" === d ? G(c, 13, e) : "cbr" === d ? G(c, 87, e) : "cbrver" === d ? G(c, 88, e) : "cos" === d ? G(c, 18, e) : "cosver" === d ? G(c, 19, e) : "cplatform" === d && G(c, 42, e);
        H(b, 1, c);
        return b
    }
    ...
    function aj(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                ...
                null !== d && G(c, 3, d);
                H(b, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = Ti())
    }

    function bj(a, b, c) {
        a = a.Ba;
        if (("WEB_REMIX" === a || 76 === a) && !P("music_web_display_mode_killswitch"))
            if (b) {
                var d;
                c = null != (d = Lc(b, ig, 70)) ? d : new ig;
                d = Ui();
                null !== d && G(c, 10, d);
                H(b, 70, c)
            } else if (c) {
            var e;
            c.client.Sa = null != (e = c.client.Sa) ? e : {};
            c.client.Sa.webDisplayMode = Ti()
        }
    }

    function cj(a, b) {
        var c;
        if (P("web_log_memory_total_kbytes") && (null == (c = A.navigator) ? 0 : c.deviceMemory)) {
            var d;
    ...
    function ej(a, b) {
        a: {
            var c = Zi();
            if (c) {
                var d = Vi[c.type || "unknown"] || "CONN_UNKNOWN";
                c = Vi[c.effectiveType || "unknown"] || "CONN_UNKNOWN";
        ...
        d && (a ? G(a, 61, Wi[d]) : b && (b.client.connectionType = d));P("web_log_effective_connection_type") && (d = Zi(), d = null !== d && void 0 !== d && d.effectiveType ? Yi.hasOwnProperty(d.effectiveType) ? Yi[d.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, d &&
    ...
    function fj(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = {};
        P("enable_web_eom_visitor_data") && N("EOM_VISITOR_DATA") ? d = {
        ...
        (b = c.Mb || N("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().Lb : b = Dd([]));
        b && (d.Authorization = b, d["X-Goog-AuthUser"] = N("SESSION_INDEX", 0), P("pageid_as_header_web") && (d["X-Goog-PageId"] = N("DELEGATED_SESSION_ID")));
        return d
    };
    ...
    function hj(a) {
        var b = new Yf;
        (b = b.isAvailable() ? a ? new dg(b, a) : b : null) || (a = new Zf(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
    ...
    function kj(a, b, c, d) {
        ...
        jj().set("nextId", d + 1, 86400, !0);
        jj().set("requests", e, 86400, !0);
        return d
    }

    function lj(a) {
        var b = jj().get("requests", !0) || {};
        delete b[a];
        jj().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(Q()) - d.requestTime)) {
                    var e = d.authState,
                        f = gj(fj(!1));
                    jb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(Q())), Ki(a, d.method, e, {}));
                    delete b[c]
                }
            }
            jj().set("requests", b, 86400, !0)
    ...
    function pj() {
        var a;
        return null === (a = oj()) || void 0 === a ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    };
    var qj = [],
        rj = !1;
    ...
    function kk() {
        ...
        throw new ii("Datasync ID not set", "unknown");
    };
    ...
    var nk = {},
        ok = (nk.AUTH_INVALID = "No user identifier specified.", nk.EXPLICIT_ABORT = "Transaction was explicitly aborted.", nk.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", nk.MISSING_INDEX = "Index not created.", nk.MISSING_OBJECT_STORES = "Object stores not created.", nk.DB_DELETED_BY_MISSING_OBJECT_STORES = "Database is deleted because expected object stores were not created.", nk.DB_REOPENED_BY_MISSING_OBJECT_STORES = "Database is reopened because expected object stores were not created.", nk.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
            nk.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", nk.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", nk.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", nk.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", nk),
        pk = {},
        qk = (pk.AUTH_INVALID = "ERROR", pk.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", pk.EXPLICIT_ABORT = "IGNORED", pk.IDB_NOT_SUPPORTED = "ERROR", pk.MISSING_INDEX =
            "WARNING", pk.MISSING_OBJECT_STORES = "ERROR", pk.DB_DELETED_BY_MISSING_OBJECT_STORES = "WARNING", pk.DB_REOPENED_BY_MISSING_OBJECT_STORES = "WARNING", pk.QUOTA_EXCEEDED = "WARNING", pk.QUOTA_MAYBE_EXCEEDED = "WARNING", pk.UNKNOWN_ABORT = "WARNING", pk.INCOMPATIBLE_DB_VERSION = "WARNING", pk),
        rk = {},
        sk = (rk.AUTH_INVALID = !1, rk.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, rk.EXPLICIT_ABORT = !1, rk.IDB_NOT_SUPPORTED = !1, rk.MISSING_INDEX = !1, rk.MISSING_OBJECT_STORES = !1, rk.DB_DELETED_BY_MISSING_OBJECT_STORES = !1, rk.DB_REOPENED_BY_MISSING_OBJECT_STORES = !1, rk.QUOTA_EXCEEDED = !1, rk.QUOTA_MAYBE_EXCEEDED = !0, rk.UNKNOWN_ABORT = !0, rk.INCOMPATIBLE_DB_VERSION = !1, rk);
    ...
    function uk(a, b) {
        ...
        this.index = a;
        this.objectStore = b;
        Object.setPrototypeOf(this, uk.prototype)
    }
    v(uk, Error);
    var vk = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    ...
    function wk(a, b, c, d) {
        ...
        if (nc && "UnknownError" === e.name) return new T("QUOTA_MAYBE_EXCEEDED", a);
        if (e instanceof uk) return new T("MISSING_INDEX", Object.assign(Object.assign({}, a), {
            objectStore: e.objectStore,
            index: e.index
        }));
        if ("InvalidStateError" === e.name && vk.some(function(f) {
    ...
    W.all = function(a) {
        return new W(new Ak(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    Z: f.Z
                }, ++f.Z) Bk(W.resolve(a[f.Z]).then(function(g) {
                return function(h) {
                    d[g.Z] = h;
                    e--;
                    0 === e && b(d)
    ...
    W.prototype.then = function(a, b) {
        var c = this,
            d = null !== a && void 0 !== a ? a : zk,
            e = null !== b && void 0 !== b ? b : yk;
        return new W(new Ak(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                Ck(c, c, d, f, g)
            }), c.onRejected.push(function() {
                Dk(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? Ck(c, c, d, f, g) : "REJECTED" === c.state.status && Dk(c, c, e, f, g)
        }))
    };
    ...
    function Ck(a, b, c, d, e) {
        try {
            ...
            f instanceof W ? Ek(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function Hk(a, b) {
        return new W(new Ak(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
        ...
        return x(function(F) {
            switch (F.h) {
                ...
                case 2:
                    ...
                    return w(F, M, 6);
                case 6:
                    return n = F.i, r = Math.round(Q()), Pk(a, k, r, g, void 0, b.join(), e), F.return(n);
                case 4:
                    q = ua(F);
                    p = Math.round(Q());
                    z = wk(q, a.h.name, b.join(), a.h.version);
                    if ((y = z instanceof T && !z.h) || g >= f) Pk(a, k, p, g, z, b.join(), e), h = z;
                    F.o(2);
                    break;
                case 3:
    ...
    function Pk(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof T && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && tj("QUOTA_EXCEEDED", {
            dbName: mk(a.h.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof T && "UNKNOWN_ABORT" === e.type && (c -= a.j, 0 > c && c >= Math.pow(2, 31) && (c = 0), tj("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.i = !0), Qk(a, !1, d, f, b, g.tag), sj(e)) : Qk(a, !0, d, f, b, g.tag)
    }

    function Qk(a, b, c, d, e, f) {
        tj("TRANSACTION_ENDED", {
            objectStoreNames: d,
    ...
    m.delete = function(a) {
        return a instanceof IDBKeyRange ? Rk(this, a) : X(this.h.delete(a))
    };
    m.get = function(a) {
    ...
    m.index = function(a) {
        try {
            return new Tk(this.h.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new uk(a, this.h.name);
            throw b;
        }
    };
    m.getName = function() {
    ...
    Nk.prototype.abort = function() {
        this.h.abort();
        this.i = !0;
        throw new T("EXPLICIT_ABORT");
    };
    Nk.prototype.objectStore = function(a) {
        a = this.h.objectStore(a);
        var b = this.j.get(a);
        b || (b = new Lk(a), this.j.set(a, b));
        return b
    };
    ...
    function Uk(a) {
        return X(a).then(function(b) {
            return b ? new Wk(a, b) : null
        })
    }
    m = Wk.prototype;
    m.advance = function(a) {
        this.cursor.advance(a);
        return Uk(this.request)
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(p) {
                try {
                    ...
                    p.dataLoss && "none" !== p.dataLoss && tj("IDB_DATA_CORRUPTED", {
                        reason: p.dataLossMessage || "unknown reason",
                        dbName: mk(a)
                    });
                    var z = f(),
                        y = new Nk(g.transaction);
                    n && n(z, function(F) {
                        return p.oldVersion < F && p.newVersion >= F
                    }, y);
                    y.done.catch(function(F) {
                        e(F)
                    })
                } catch (F) {
                    e(F)
    ...
    function cl(a, b) {
        if (!b) throw xk("openWithToken", mk(a.name));
        return a.open()
    }
    al.prototype.open = function() {
        function a() {
            var f, g, h, k, l, n, r, q, p, z;
            return x(function(y) {
                switch (y.h) {
                    case 1:
                    ...
                    case 4:
                        k = y.i;
                        for (var F = c.options, M = [], J = u(Object.keys(F.ga)), O = J.next(); !O.done; O = J.next()) {
                            O = O.value;
                            var fb = F.ga[O],
                                ic = void 0 === fb.rb ? Number.MAX_VALUE : fb.rb;
                            !(k.h.version >= fb.ya) || k.h.version >= ic || k.h.objectStoreNames.contains(O) || M.push(O)
                        }
                        l = M;
                        if (0 === l.length) {
                            y.o(5);
                        ...
                        n = Object.keys(c.options.ga);
                        r = k.objectStoreNames();
                        if (c.v < Ch("ytidb_reopen_db_retries", 0)) return c.v++, k.close(), sj(new T("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                            dbName: c.name,
                            expectedObjectStores: n,
                            foundObjectStores: r
                        })), y.return(a());
                        if (!(c.m < Ch("ytidb_remake_db_retries", 1))) {
                            y.o(6);
                            break
                        }
                        c.m++;
                        if (!P("ytidb_remake_db_enable_backoff_delay")) {
                            y.o(7);
                            break
                        }
                        return w(y, $k(c.i), 8);
                    ...
                    case 9:
                        return sj(new T("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                                dbName: c.name,
                                expectedObjectStores: n,
                                foundObjectStores: r
                            })),
                    ...
                    case 11:
                        p = y.i;
                        z = p.h.version;
                        if (void 0 !== c.options.version && z >
                            c.options.version + 1) throw p.close(), c.l = !1, bl(c, z);
                        return y.return(p);
                    case 10:
                        throw b(), q instanceof Error && !P("ytidb_async_stack_killswitch") && (q.stack = q.stack + "\n" + h.substring(h.indexOf("\n") + 1)), wk(q, c.name, "", null !== (g = c.options.version) && void 0 !== g ? g : -1);
                }
            })
        }
    ...
    function el(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.h) return w(d, cl(dl, b), 2);
            c = d.i;
            return d.return(Jk(c, ["databases"], {
                H: !0,
                mode: "readwrite"
            }, function(e) {
                var f = e.objectStore("databases");
                return f.get(a.actualName).then(function(g) {
                    if (g ? a.actualName !== g.actualName || a.publicName !== g.publicName || a.userIdentifier !== g.userIdentifier : 1) return X(f.h.put(a, void 0)).then(function() {})
                })
            }))
        })
    }
    ...
    function fl(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.h) return a ? w(d, cl(dl, b), 2) : d.return();
            c = d.i;
    ...
    function gl(a, b) {
        var c, d;
        return x(function(e) {
            return 1 == e.h ? (c = [], w(e, cl(dl, b), 2)) : 3 != e.h ? (d = e.i, w(e, Jk(d, ["databases"], {
                H: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
                return Sk(f.objectStore("databases"), {}, function(g) {
                    a(g.W()) && c.push(g.W());
                    return g.continue()
                })
            }), 3)) : e.return(c)
        ...
        return x(function(d) {
            switch (d.h) {
                case 1:
                    ...
                    var e;
                    if (e = nj) e = /WebKit\/([0-9]+)/.exec(Fb()), e = !!(e && 600 <= parseInt(e[1], 10));
                    e && (e = /WebKit\/([0-9]+)/.exec(Fb()), e = !(e && 602 <= parseInt(e[1], 10)));
                    if (e || Zb) return d.return(!1);
                    try {
                    ...
                    return w(d, el(c, jl), 4);
                case 4:
                    return w(d, fl("yt-idb-test-do-not-use", jl), 5);
                case 5:
                    return d.return(!0);
                case 2:
    ...
    function ll() {
        if (void 0 !== il) return il;
        rj = !0;
        return il = kl().then(function(a) {
            rj = !1;
            var b, c;
            null !== (b = oj()) && void 0 !== b && b.h && (b = pj(), b = {
                hasSucceededOnce: (null === b || void 0 === b ? void 0 : b.hasSucceededOnce) || a
            }, null === (c = oj()) || void 0 === c ? void 0 : c.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0));
            return a
        })
    }
    ...
    function nl() {
        var a = ml();
        return a ? Promise.resolve(a) : ll().then(function(b) {
            (b = b ? jl : void 0) && C("ytglobal.idbToken_", b);
            return b
        })
    };
    new Ze;
    ...
    function ol(a) {
        if (!uj()) throw a = new T("AUTH_INVALID", {
            dbName: a
        }), sj(a), a;
        var b = kk();
        return {
    ...
    function pl(a, b, c, d) {
        ...
        return x(function(n) {
            switch (n.h) {
                case 1:
                    return f = null !== (e = Error().stack) && void 0 !== e ? e : "", w(n, nl(), 2);
                case 2:
                    g = n.i;
                    if (!g) throw h = xk("openDbImpl", a, b), P("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), sj(h), h;
                    lk(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                    ...
                    return w(n, el(k, g), 5);
                case 5:
                    return w(n, Yk(k.actualName, b, d), 6);
                case 6:
                    return n.return(n.i);
                case 3:
                    return l = ua(n), sa(n, 7), w(n, fl(k.actualName,
                        g), 9);
                case 9:
                    ta(n, 8);
                    break;
    ...
    function sl(a, b) {
        ...
        var c, d;
        return x(function(e) {
            if (1 == e.h) return w(e, nl(), 2);
            if (3 != e.h) {
                c = e.i;
                if (!c) return e.return();
                lk(a);
                d = ol(a);
                return w(e, Zk(d.actualName, b), 3)
            }
            return w(e, fl(d.actualName, c), 0)
        })
    }
    ...
    function tl(a, b, c) {
        a = a.map(function(d) {
            return x(function(e) {
                return 1 == e.h ? w(e, Zk(d.actualName, b), 2) : w(e, fl(d.actualName, c), 0)
            })
        });
    ...
    function wl(a) {
        ...
        this.Ya = null !== (c = a.Ya) && void 0 !== c ? c : 1;
        this.Wa = null !== (d = a.Wa) && void 0 !== d ? d : 2592E6;
        this.Va = null !== (e = a.Va) && void 0 !== e ? e : 12E4;
        this.Xa = null !== (f = a.Xa) && void 0 !== f ? f : 5E3;
        this.s = null !== (g = a.s) && void 0 !== g ? g : void 0;
        this.pa = !!a.pa;
        this.oa = null !== (h = a.oa) && void 0 !== h ? h : .1;
        this.va = null !== (k = a.va) && void 0 !== k ? k : 10;
        ...
        this.Fa = a.Fa;
        this.Ea = a.Ea;
        this.s && (!this.B || this.B("networkless_logging")) && xl(this)
    }

    function xl(a) {
        a.s && !a.ea && (a.h = !0, a.pa && Math.random() <= a.oa && a.D.hb(a.s), yl(a), a.G.F() && a.ja(), a.G.R(a.Fa, a.ja.bind(a)), a.G.R(a.Ea, a.Ja.bind(a)))
    }
    m = wl.prototype;
    ...
    m.ja = function() {
        var a = this;
        if (!this.s) throw xk("throttleSend");
        this.i || (this.i = this.J.L(function() {
            var b;
            return x(function(c) {
                if (1 == c.h) return w(c, a.D.Oa("NEW", a.s), 2);
                if (3 != c.h) return b = c.i, b ? w(c, zl(a, b), 3) : (a.Ja(), c.return());
                a.i && (a.i = 0, a.ja());
                c.h = 0
            })
        }, this.Za))
    ...
    function zl(a, b) {
        ...
        return x(function(e) {
            switch (e.h) {
                case 1:
                    if (!a.s) throw c = xk("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.o(2);
                        break
                    }
                    return w(e, a.D.pb(b.id, a.s), 3);
                case 3:
    ...
    function Cl(a, b) {
        if (!a.s) throw xk("updateRequestHandlers");
        ...
        b.options.onError = function(e, f) {
            ...
            return x(function(h) {
                switch (h.h) {
                    case 1:
                        g = Dl(f);
                        if (!(a.B && a.B("nwl_consider_error_code") && g || a.B && !a.B("nwl_consider_error_code") && a.potentialEsfErrorCounter <= a.va)) {
                            h.o(2);
                            break
                        }
                        if (!a.G.U) {
                    ...
                    case 3:
                        ...
                        return w(h, a.D.Ga(b.id, a.s, !1), 6);
                    case 6:
                        return h.return();
                    case 2:
                        if (a.B && a.B("nwl_consider_error_code") &&
                            !g && a.potentialEsfErrorCounter > a.va) return h.return();
                        a.potentialEsfErrorCounter++;
                        if (void 0 === (null === b || void 0 === b ? void 0 : b.id)) {
                            h.o(8);
                            break
                        }
                        return b.sendCount < a.Ya ? w(h, a.D.Ga(b.id, a.s), 12) : w(h, a.D.aa(b.id, a.s), 8);
                    case 12:
                        a.J.L(function() {
                            a.G.F() && a.ja()
                        }, a.Xa);
    ...
    function yl(a) {
        if (!a.s) throw xk("retryQueuedRequests");
        a.D.Oa("QUEUED", a.s).then(function(b) {
            b && !Bl(a, b, a.Va) ? a.J.L(function() {
                return x(function(c) {
                    if (1 == c.h) return void 0 === b.id ? c.o(2) : w(c, a.D.Ga(b.id, a.s), 2);
                    yl(a);
                    c.h = 0
                })
            }) : a.G.F() && a.ja()
    ...
    var El = B("ytPubsub2Pubsub2Instance") || new L;
    L.prototype.subscribe = L.prototype.subscribe;
    L.prototype.unsubscribeByKey = L.prototype.ka;
    L.prototype.publish = L.prototype.ca;
    L.prototype.clear = L.prototype.clear;
    C("ytPubsub2Pubsub2Instance", El);
    ...
    Fl.prototype.j = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Ha ? rl : ql)(a, b, Object.assign({}, c))
    };
    Fl.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Ha ? vl : sl)(this.name, a)
    };
    ...
    function Jl() {
        if (Il) return Il();
        var a = {};
        Il = Hl("LogsDatabaseV2", {
            ga: (a.LogsRequestsStore = {
                ya: 2
            }, a),
            Ha: !1,
            upgrade: function(b, c, d) {
                c(2) && Kk(b, "LogsRequestsStore", {
                    keyPath: "id",
                    autoIncrement: !0
                });
                c(3);
    ...
    function Nl(a, b) {
        ...
        return x(function(l) {
            ...
            if (3 != l.h) return d = l.i, e = N("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, Q()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, Jk(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    H: !0
                }, function(n) {
                    return Vk(n.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: h,
                        direction: "prev"
                    }, function(r) {
                        r.W() && (k = r.W(), "NEW" === a && (k.status = "QUEUED", r.update(k)))
                    })
                }),
                3);
            c.ub = Q();
    ...
    function Ol(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.h) return w(d, Kl(b), 2);
            c = d.i;
            return d.return(Jk(c, ["LogsRequestsStore"], {
                mode: "readwrite",
                H: !0
            }, function(e) {
                var f = e.objectStore("LogsRequestsStore");
                return f.get(a).then(function(g) {
                    if (g) return g.status = "QUEUED", X(f.h.put(g, void 0)).then(function() {
                        return g
                    })
                })
            }))
    ...
    function Pl(a, b, c) {
        ...
        var d;
        return x(function(e) {
            if (1 == e.h) return w(e, Kl(b), 2);
            d = e.i;
            return e.return(Jk(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                H: !0
            }, function(f) {
                var g = f.objectStore("LogsRequestsStore");
                return g.get(a).then(function(h) {
                    return h ? (h.status = "NEW", c && (h.sendCount += 1), X(g.h.put(h, void 0)).then(function() {
                        return h
                    })) : W.resolve(void 0)
                })
            }))
    ...
    function Rl(a) {
        var b, c;
        return x(function(d) {
            if (1 == d.h) return w(d, Kl(a), 2);
            b = d.i;
            c = Q() - 2592E6;
            return w(d, Jk(b, ["LogsRequestsStore"], {
                mode: "readwrite",
                H: !0
            }, function(e) {
                return Sk(e.objectStore("LogsRequestsStore"), {}, function(f) {
    ...
    function Ml(a) {
        if (!P("nwl_csi_killswitch") && .01 >= Math.random()) {
    ...
    var Tl = {},
        Ul = Hl("ServiceWorkerLogsDatabase", {
            ga: (Tl.SWHealthLog = {
                ya: 1
            }, Tl),
            Ha: !0,
            upgrade: function(a, b) {
                b(1) && Kk(a, "SWHealthLog", {
                    keyPath: "id",
                    autoIncrement: !0
    ...
    function Wl(a) {
        var b, c;
        x(function(d) {
            if (1 == d.h) return w(d, Vl(a), 2);
            b = d.i;
            c = Q() - 2592E6;
            return w(d, Jk(b, ["SWHealthLog"], {
                mode: "readwrite",
                H: !0
            }, function(e) {
                return Sk(e.objectStore("SWHealthLog"), {}, function(f) {
                    if (f.W().timestamp <= c) return f.delete().then(function() {
                        return f.continue()
                    })
                })
    ...
    function $l(a) {
        var b = void 0 === b ? "" : b;
        if (a)
            if (b) $h(a, void 0, "POST", b, void 0);
            else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) $h(a, void 0, "GET", "", void 0);
        else {
            b: {
                try {
                    var c = new Ya({
                    ...
                    if (c.j && c.i || c.l) {
                        var d = Kb(a.match(Jb)[5] || null);
                        var e = !(!d || !d.endsWith("/aclk") || "1" !== Ub(a, "ri"));
                        break b
                    }
                } catch (g) {}
                e = !1
    ...
    function cm() {
        if (!bm.h) {
            var a = B("yt.networkRequestMonitor.instance") || new bm;
            C("yt.networkRequestMonitor.instance", a);
            bm.h = a
        }
        return bm.h
    }
    bm.prototype.requestComplete = function(a, b) {
        b && (this.i = !0);
        a = this.removeParams(a);
        this.h.get(a) || this.h.set(a, b)
    };
    bm.prototype.isEndpointCFR = function(a) {
        a = this.removeParams(a);
        return (a = this.h.get(a)) ? !1 : !1 === a && this.i ? !0 : null
    };
    bm.prototype.removeParams = function(a) {
        return a.split("?")[0]
    };
    bm.prototype.removeParams = bm.prototype.removeParams;
    bm.prototype.isEndpointCFR = bm.prototype.isEndpointCFR;
    bm.prototype.requestComplete = bm.prototype.requestComplete;
    bm.getInstance = cm;
    var dm;

    function em() {
        dm || (dm = new hj("yt.offline"));
        return dm
    }

    function fm(a) {
        if (P("offline_error_handling")) {
            var b = em().get("errors", !0) || {};
            b[a.message] = {
                name: a.name,
                stack: a.stack
            };
            a.level && (b[a.message].level = a.level);
            em().set("errors", b, 2592E3, !0)
        }
    }

    function gm() {
        if (P("offline_error_handling")) {
            var a = em().get("errors", !0);
            if (a) {
                for (var b in a)
                    if (a[b]) {
                        var c = new ii(b, "sent via offline_errors");
                        c.name = a[b].name;
                        c.stack = a[b].stack;
                        c.level = a[b].level;
                        gh(c)
                    }
                em().set("errors", {}, 2592E3, !0)
            }
        }
    };
    var hm = Ch("network_polling_interval", 3E4);
    ...
    function Y() {
        ...
        this.la = this.m = !1;
        this.i = this.za();
        P("use_shared_nsm") ? (this.h = ne(), P("use_shared_nsm_and_keep_yt_online_updated") && (this.h.R("networkstatus-online", function() {
            a.i = !0
    ...
    m.F = function() {
        var a;
        return P("use_shared_nsm") && this.h ? null === (a = this.h) || void 0 === a ? void 0 : a.F() : this.i
    };
    m.S = function(a) {
        var b;
        P("use_shared_nsm") && this.h ? null === (b = this.h) || void 0 === b ? void 0 : b.h = a : a !== this.i && (this.i = a)
    };
    m.qb = function(a) {
        !P("use_shared_nsm") && (this.m = !0, void 0 === a ? 0 : a) && (this.O || lm(this))
    };
    m.za = function() {
    ...
    m.R = function(a, b) {
        return P("use_shared_nsm") && this.h ? this.h.R(a, b) : K.prototype.R.call(this, a, b)
    };
    ...
    function lm(a) {
        a.O = Ih(function() {
            return x(function(b) {
                if (1 == b.h) return a.i ? a.za() || !a.m ? b.o(3) : w(b, a.U(), 3) : w(b, a.U(), 3);
                lm(a);
                b.h = 0
            })
        }, hm)
    ...
    m.U = function(a) {
        var b = this;
        if (P("use_shared_nsm") && this.h) {
            var c = le(this.h, a);
            c.then(function(d) {
                P("use_cfr_monitor") && cm().requestComplete("generate_204", d)
            });
            return c
        }
        return this.u ? this.u : this.u = new Promise(function(d) {
            ...
            return x(function(h) {
                switch (h.h) {
                    case 1:
                        return e = window.AbortController ? new window.AbortController : void 0, f = null === e || void 0 === e ? void 0 : e.signal, g = !1, sa(h, 2, 3), e && (b.A = oe.L(function() {
                            e.abort()
                    ...
                    case 3:
                        va(h);
                        P("use_cfr_monitor") && cm().requestComplete("generate_204", g);
                        b.u = void 0;
                        b.A && oe.Y(b.A);
                        g !== b.i && (b.i = g, b.i && b.m ? ie(b, "ytnetworkstatus-online") : b.m && ie(b, "ytnetworkstatus-offline"));
                        d(g);
                        wa(h);
                        break;
                    case 2:
    ...
    Y.prototype.sendNetworkCheckRequest = Y.prototype.U;
    Y.prototype.listen = Y.prototype.R;
    Y.prototype.enableErrorFlushing = Y.prototype.jb;
    Y.prototype.getWindowStatus = Y.prototype.za;
    Y.prototype.monitorNetworkStatusChange = Y.prototype.qb;
    Y.prototype.networkStatusHint = Y.prototype.S;
    ...
    function mm(a) {
        ...
        P("use_shared_nsm") && (this.m = "networkstatus-offline", this.u = "networkstatus-online");
        this.h = km();
        var c = B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.h);
        c && c(a.Ma);
        a.sa && !P("use_shared_nsm") && (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.h)) && c();
        if (c = B("yt.networkStatusManager.instance.listen").bind(this.h)) a.wa ?
            (this.wa = a.wa, c(this.u, function() {
                nm(b, "publicytnetworkstatus-online");
                P("use_shared_nsm") && a.sa && gm()
            }), c(this.m, function() {
                nm(b, "publicytnetworkstatus-offline")
            })) : (c(this.u, function() {
    ...
    mm.prototype.U = function(a) {
        ...
        return x(function(d) {
            ...
            return P("skip_network_check_if_cfr") && cm().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
                b.S((null === (f = window.navigator) || void 0 === f ? void 0 : f.onLine) || !0);
                e(b.F())
    ...
    function nm(a, b) {
        a.wa ? a.i ? (oe.Y(a.O), a.O = oe.L(function() {
            a.A !== b && (ie(a, b), a.A = b, a.i = Q())
        }, a.wa - (Q() - a.i))) : (ie(a, b), a.A = b, a.i = Q()) : ie(a, b)
    };
    var om;
    ...
    function pm() {
        wl.call(this, {
            ...
            ab: fm,
            J: Mh(),
            Fa: "publicytnetworkstatus-online",
            Ea: "publicytnetworkstatus-offline",
            pa: !0,
            oa: .1,
            va: Ch("potential_esf_error_limit", 10),
            B: P,
            ea: !(uj() && (P("embeds_web_nwl_disable_nocookie") ? "www.youtube-nocookie.com" !== Lb(document.location.toString()) : 1))
        });
        this.j = new Ze;
        P("networkless_immediately_drop_all_requests") && Sl();
        vl("LogsDatabaseV2")
    }
    v(pm, wl);
    ...
    function sm() {
        ...
        a || (a = new pm, C("yt.networklessRequestController.instance", a), P("networkless_logging") && nl().then(function(b) {
            a.s = b;
            xl(a);
            a.j.resolve();
            a.pa && Math.random() <= a.oa && a.s && Wl(a.s);
            P("networkless_immediately_drop_sw_health_store") && tm(a)
        }));
        return a
    }
    pm.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        uj() || (this.h = !1);
        wl.prototype.writeThenSend.call(this, a, b)
    };
    pm.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        uj() || (this.h = !1);
        wl.prototype.sendThenWrite.call(this, a, b, c)
    };
    pm.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        uj() || (this.h = !1);
        wl.prototype.sendAndWrite.call(this, a, b)
    };
    pm.prototype.awaitInitialization = function() {
    ...
    function tm(a) {
        var b;
        x(function(c) {
            if (!a.s) throw b = xk("clearSWHealthLogsDb"), b;
            return c.return(Xl(a.s).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    ...
    function um(a, b) {
        ...
        b.onError = function(e, f) {
            cm().requestComplete(a, !1);
            c(e, f)
        };
        var d = b.onSuccess ? b.onSuccess : function() {};
        b.onSuccess = function(e, f) {
            cm().requestComplete(a, !0);
            d(e, f)
        }
    };
    var vm = 0,
        wm = 0,
        xm, ym = A.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
            potentialEsfErrorCounter: wm
        };
    C("ytNetworklessLoggingInitializationOptions", ym);

    function zm(a, b) {
        function c(d) {
            var e = Am().F();
            if (!Bm() || !d || e && P("vss_networkless_bypass_write")) Cm(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        P("skip_is_supported_killswitch") ? nl().then(function(d) {
            c(d)
        }) : c(ml())
    }
        ...
        function c(d) {
            if (Bm() && d) {
                ...
                e.options.onSuccess = function(k, l) {
                    P("use_cfr_monitor") && cm().requestComplete(e.url, !0);
                    void 0 !== e.id ? Ql(e.id, d) : f = !0;
                    P("vss_network_hint") && Am().S(!0);
                    g(k, l)
                };
                if (P("use_cfr_monitor")) {
                    var h = b.onError ? b.onError : function() {};
                    e.options.onError = function(k, l) {
                        cm().requestComplete(e.url, !1);
                        h(k, l)
                    }
                }
                Cm(e.url, e.options);
                Ll(e, d).then(function(k) {
                    e.id = k;
                    f && Ql(e.id, d)
                }).catch(function(k) {
                    Am().F() ? gh(k) : fm(k)
    ...
    function Fm() {
        var a = ml();
        if (!a) throw xk("throttleSend");
        vm || (vm = oe.L(function() {
            var b;
            return x(function(c) {
                if (1 == c.h) return w(c, Nl("NEW", a), 2);
                if (3 != c.h) return b = c.i, b ? w(c, Dm(b), 3) : (oe.Y(vm), vm = 0, c.return());
                vm && (vm = 0, Fm());
                c.h = 0
            })
        }, 100))
    ...
    function Dm(a) {
        ...
        return x(function(e) {
            switch (e.h) {
                case 1:
                    b = ml();
                    if (!b) throw c = xk("immediateSend"), c;
                    if (void 0 === a.id) {
                        e.o(2);
                        break
                    }
                    return w(e, Ol(a.id, b), 3);
                case 3:
                    (d = e.i) ? a = d: hh(Error("The request cannot be found in the database."));
                case 2:
                    var f = a.timestamp;
                    if (!(2592E6 <= Q() - f)) {
                        e.o(4);
                    ...
                    hh(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === a.id) {
                        e.o(5);
                        break
                    }
                    return w(e, Ql(a.id, b), 5);
                case 5:
                    return e.return();
                case 4:
                    a.skipRetry || (a = Gm(a));
                    ...
                    var g, h;
                    if (null ===
                        (h = null === (g = null === f || void 0 === f ? void 0 : f.options) || void 0 === g ? void 0 : g.postParams) || void 0 === h ? 0 : h.requestTimeMs) f.options.postParams.requestTimeMs = Math.round(Q());
                    a = f;
                    if (!a) {
                        e.o(0);
                        break
                    ...
                    return w(e, Ql(a.id, b), 8);
                case 8:
                    Cm(a.url, a.options, !!a.skipRetry), e.h = 0
            }
        })
    }
    ...
    function Gm(a) {
        var b = ml();
        if (!b) throw xk("updateRequestHandlers");
        ...
        a.options.onError = function(e, f) {
            ...
            return x(function(h) {
                switch (h.h) {
                    case 1:
                        P("use_cfr_monitor") && cm().requestComplete(a.url, !1);
                        g = Dl(f);
                        if (!(P("nwl_consider_error_code") && g || !P("nwl_consider_error_code") && Hm() <= Ch("potential_esf_error_limit", 10))) {
                            h.o(2);
                            break
                        }
                        if (P("skip_checking_network_on_cfr_failure") && (!P("skip_checking_network_on_cfr_failure") || cm().isEndpointCFR(a.url))) {
                            h.o(3);
                            break
                        }
                        return w(h, Am().U(), 3);
                    case 3:
                        ...
                        c(e, f);
                        if (!P("nwl_consider_error_code") || void 0 ===
                            (null === a || void 0 === a ? void 0 : a.id)) {
                            h.o(6);
                            break
                        }
                        return w(h, Pl(a.id, b, !1), 6);
                    case 6:
                        return h.return();
                    case 2:
                        if (P("nwl_consider_error_code") && !g && Hm() > Ch("potential_esf_error_limit", 10)) return h.return();
                        B("ytNetworklessLoggingInitializationOptions") && ym.potentialEsfErrorCounter++;
                        wm++;
                        if (void 0 === (null === a || void 0 === a ? void 0 : a.id)) {
                            h.o(8);
                            break
                        }
                        return 1 > a.sendCount ? w(h, Pl(a.id, b), 12) : w(h, Ql(a.id, b), 8);
                    case 12:
                        oe.L(function() {
                            Am().F() && Fm()
                        }, 5E3);
        ...
        a.options.onSuccess = function(e, f) {
            return x(function(g) {
                if (1 == g.h) return P("use_cfr_monitor") && cm().requestComplete(a.url, !0), void 0 === (null === a || void 0 === a ? void 0 : a.id) ? g.o(2) : w(g, Ql(a.id, b), 2);
                P("vss_network_hint") && Am().S(!0);
                d(e, f);
                g.h = 0
            })
    ...
    function Bm() {
        return B("ytNetworklessLoggingInitializationOptions") ? ym.isNwlInitialized : !1
    }

    function Hm() {
        return B("ytNetworklessLoggingInitializationOptions") ? ym.potentialEsfErrorCounter : wm
    };

    function Im(a) {
        var b = this;
        this.config_ = null;
        a ? this.config_ = a : $i() && (this.config_ = Gi());
        Ih(function() {
            mj(b)
        }, 5E3)
    }
    Im.prototype.isReady = function() {
        !this.config_ && $i() && (this.config_ = Gi());
        return !!this.config_
    };
    ...
    function Ki(a, b, c, d) {
        function e(z) {
            z = void 0 === z ? !1 : z;
            var y;
            if (d.retry && "www.youtube-nocookie.com" != h && (z || P("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (y = kj(b, c, l, k)), y)) {
                var F = g.onSuccess,
                    M = g.onFetchSuccess;
                g.onSuccess = function(J, O) {
                    lj(y);
                    F(J, O)
                };
                c.onFetchSuccess = function(J, O) {
                    lj(y);
                    M(J, O)
                }
            }
            try {
                z && d.retry && !d.Ta.bypassNetworkless ? (g.method = "POST", d.Ta.writeThenSend ? P("use_new_nwl_wts") ? sm().writeThenSend(p, g) : zm(p, g) : P("use_new_nwl_saw") ? sm().sendAndWrite(p, g) : Em(p, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), Xh(p, g))
            } catch (J) {
                if ("InvalidAccessError" == J.name) y && (lj(y), y = 0), hh(Error("An extension is blocking network request."));
                else throw J;
            }
            y && Ih(function() {
                mj(a)
            }, 5E3)
        }!N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && hh(new ii("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
            var f = new ii("innertube xhrclient not ready", b, c, d);
            gh(f);
            throw f;
        }
        var g = {
        ...
        q || (r.key = a.config_.innertubeApiKey);
        var p = zh("" + h + n, r || {}, !0);
        P("use_new_nwl") && sm().h || !P("use_new_nwl") &&
            Bm() ? ll().then(function(z) {
                e(z)
            }) : e(!1)
    };
    ...
    function Jm(a, b) {
        var c = void 0 === c ? {} : c;
        var d = Im;
        N("ytLoggingEventsDefaultDisabled", !1) && Im == Im && (d = null);
        a: {
            c = void 0 === c ? {} : c;
            if (P("lr_drop_other_and_business_payloads")) {
                if (Gh[a] || Fh[a]) break a
            } else if (P("lr_drop_other_payloads") && Gh[a]) break a;
            var e = {},
                f = Math.round(c.timestamp || Q());e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0;e[a] = b;a = Nh();e.context = {
                lastActivityMs: String(c.timestamp || !isFinite(a) ? -1 : a)
            };P("log_sequence_info_on_gel_web") && c.ia && (a = e.context, b = c.ia, b = {
                    index: Si(b),
                    groupKey: b
                }, a.sequence =
                b, c.kb && delete Ri[c.ia]);
            (c.sb ? Bi : vi)({
                endpoint: "log_event",
                payload: e,
                P: c.P,
    ...
    function Pm() {
        if (!Om) {
            ...
            a.X.length = 0;
            a.V.length = 0;
            Mm.X && a.X.push.apply(a.X, Mm.X);
            Mm.V && a.V.push.apply(a.V, Mm.V)
        }
        return Om
    };
    var Qm = new L;
    ...
    function Tm(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Um(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = Rm(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? Um(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += Um(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = Vm(a), d += c[b].length;
        else c[b] = Vm(a), d += c[b].length;
        return d
    }
    ...
    var Wm = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", Wm);

    function Xm(a) {
        var b = void 0;
        b = void 0 === b ? {} : b;
        var c = !1;
        N("ytLoggingEventsDefaultDisabled", !1) && Im === Im && (c = !0);
        c = c ? null : Im;
        b = void 0 === b ? {} : b;
        ...
        if (P("log_sequence_info_on_gel_web") && b.ia) {
            e = b.ia;
            var f = Si(e),
                g = new Eg;
            G(g, 2, f);
    ...
    var Ym = new Set,
        ...
        an = 0,
        bn = [],
        cn = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];

    function dn() {
        for (var a = u(cn), b = a.next(); !b.done; b = a.next()) {
            var c = Fb();
    ...
    function fn(a) {
        return en[a] || (en[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function kn() {
        for (var a = u(hn), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }

    function ln(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[fn(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function mn(a) {
        rf.ca.apply(rf, arguments)
    };
    ...
    function pn(a, b, c) {
        qn || (qn = {}, ph(window, "message", function(d) {
            a: {
                if (d.origin === on(a, "host")) {
                    try {
                    ...
                    if (d = qn[e.id]) d.u = !0, d.u && (D(d.v, d.sendMessage, d), d.v.length = 0), d.Ia(e)
                }
                e = void 0
            }
            return e
    ...
    m.destroy = function() {
        this.h && this.h.id && (gn[this.h.id] = null);
        var a = this.l;
    ...
    function wn(a, b) {
        ...
        c.setAttribute("title", "YouTube " + on(a.i, "title"));
        (b = on(a.i, "width")) && c.setAttribute("width", b.toString());
        (b = on(a.i, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.La();
        ...
        window.location.href && D(["debugjs", "debugcss"], function(h) {
            var k = Ub(window.location.href, h);
            null !== k && (g[h] = k)
        });
        ...
        c.src = on(a.i, "host") + ("/embed/" + on(a.i, "videoId")) + "?" + Ob(g);
        return c
    }
    m.Ua = function() {
    ...
    m.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Mb(a.src) : "https://www.youtube.com"), this.i = new nn(b), c || (b = wn(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.h = a, this.h.id || (this.h.id = "widget" + Oa(this.h)), gn[this.h.id] = this, window.postMessage) {
                this.l = new L;
                xn(this);
                b = on(this.i, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in jn) jn.hasOwnProperty(e) &&
                    un(this, e)
            }
    };

    function tn(a, b) {
        a.I[b] || (a.I[b] = !0, vn(a, "addEventListener", [b]))
    }
    m.sendMessage = function(a) {
        a.id = this.id;
        a.channel = "widget";
        var b = Ye(a),
            c = [Mb(this.h.src || "").replace("http:", "https:")];
        if (this.h.contentWindow)
            for (var d = 0; d < c.length; d++) try {
                this.h.contentWindow.postMessage(b, c[d])
            } catch (Pb) {
                if (Pb.name && "SyntaxError" === Pb.name) {
                    if (!(Pb.message && 0 < Pb.message.indexOf("target origin ''"))) {
                        var e = void 0,
                            f = Pb;
                        e = void 0 === e ? {} : e;
                        e.name = N("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
                        e.version = N("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0);
                        var g = e || {},
                            h = "WARNING";
                        h = void 0 === h ? "ERROR" :
                            h;
                        if (f) {
                            ...
                            if (!(5 <= Zm)) {
                                var n = void 0,
                                    ...
                                    z = g,
                                    y = Hd(p),
                                    F = y.message || "Unknown Error",
                                    M = y.name ||
                                    "UnknownError",
                                    J = y.stack || p.i || "Not available";
                                if (J.startsWith(M + ": " + F)) {
                                    var O = J.split("\n");
                                    O.shift();
                                    J = O.join("\n")
                                }
                                var fb = y.lineNumber || "Not available",
                                    ic = y.fileName || "Not available",
                                    Ke = J,
                                    Z = z,
                                    S = 0;
                                if (p.hasOwnProperty("args") && p.args && p.args.length)
                                    for (var U = 0; U < p.args.length && !(S = Tm(p.args[U], "params." + U, Z, S), 500 <= S); U++);
                                else if (p.hasOwnProperty("params") && p.params) {
                                    var V = p.params;
                                        ...
                                        for (r in V) {
                                            if (V[r]) {
                                                var ka = "params." + r,
                                                    vj = Vm(V[r]);
                                                Z[ka] = vj;
                                                S += ka.length + vj.length;
                                                if (500 < S) break
                                            }
                                        } else Z.params = Vm(V)
                                }
                                if (bn.length)
                                    for (var td = 0; td < bn.length && !(S = Tm(bn[td], "params.context." + td, Z, S), 500 <= S); td++);
                                navigator.vendor && !Z.hasOwnProperty("vendor") && (Z["device.vendor"] = navigator.vendor);
                                var lb = {
                                        message: F,
                                        name: M,
                                        lineNumber: fb,
                                    ...
                                    wj = Number(p.columnNumber);
                                isNaN(wj) || (lb.lineNumber = lb.lineNumber + ":" + wj);
                                if ("IGNORED" === p.level) n = 0;
                                else a: {
                                    for (var xj = Pm(), yj = u(xj.X), wf = yj.next(); !wf.done; wf = yj.next()) {
                                        var zj = wf.value;
                                        if (lb.message &&
                                            lb.message.match(zj.Qb)) {
                                            n = zj.weight;
                                            break a
                                        }
                                    }
                                    for (var Aj = u(xj.V), xf = Aj.next(); !xf.done; xf = Aj.next()) {
                                        var Bj = xf.value;
                                        if (Bj.fb(lb)) {
                                            n = Bj.weight;
                                            break a
                                ...
                                lb.sampleWeight = n;
                                q = lb;
                                for (var Cj = u(Km), yf = Cj.next(); !yf.done; yf = Cj.next()) {
                                    var zf = yf.value;
                                    if (zf.ta[q.name])
                                        for (var Dj = u(zf.ta[q.name]), Af = Dj.next(); !Af.done; Af = Dj.next()) {
                                            var Ej = Af.value,
                                                ud = q.message.match(Ej.regexp);
                                            if (ud) {
                                                q.params["params.error.original"] = ud[0];
                                                for (var Bf = Ej.groups, Fj = {}, Qb = 0; Qb < Bf.length; Qb++) Fj[Bf[Qb]] = ud[Qb + 1], q.params["params.error." +
                                                    Bf[Qb]] = ud[Qb + 1];
                                                q.message = zf.Da(Fj);
                                                break
                                            }
                                ...
                                q.params || (q.params = {});
                                var Gj = Pm();
                                q.params["params.errorServiceSignature"] = "msg=" + Gj.X.length + "&cb=" + Gj.V.length;
                                q.params["params.serviceWorker"] = "false";
                                A.document && A.document.querySelectorAll && (q.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length));
                                vb("sample").constructor !== ub && (q.params["params.fconst"] = "true");
                                var pa = q;
                                window.yterr && "function" === typeof window.yterr && window.yterr(pa);
                                if (0 !== pa.sampleWeight && !Ym.has(pa.message)) {
                                    if ("ERROR" ===
                                        h) {
                                        Qm.ca("handleError", pa);
                                        if (P("record_app_crashed_web") && 0 === an && 1 === pa.sampleWeight)
                                            if (an++, P("errors_via_jspb")) {
                                                var Cf = new Dg;
                                                G(Cf, 1, 1);
                                                ...
                                                P("report_client_error_with_app_crash_ks") || (Mj.systemHealth = {
                                                    crashData: {
                                                        clientError: {
                                                            logMessage: {
                                                                message: pa.message
                                        ...
                                        $m++
                                    } else "WARNING" === h && Qm.ca("handleWarning", pa);
                                    if (P("kevlar_gel_error_routing")) a: {
                                        var Df = void 0,
                                            Ef = void 0,
                                            rc = h,
                                            R = pa;
                                        if (P("errors_via_jspb")) {
                                            if (dn()) Ef = void 0;
                                                ...
                                                var Rb = new vg;
                                                G(Rb, 1, R.stack);
                                                R.fileName && G(Rb, 4, R.fileName);
                                                var Ga = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : [];
                                                0 !== Ga.length && (1 !== Ga.length || isNaN(Number(Ga[0])) ? 2 !== Ga.length || isNaN(Number(Ga[0])) || isNaN(Number(Ga[1])) || (G(Rb, 2, Number(Ga[0])), G(Rb, 3, Number(Ga[1]))) : G(Rb, 2, Number(Ga[0])));
                                                var mb =
                                                    new yg;
                                                G(mb, 1, R.message);
                                                G(mb, 3, R.name);
                                                G(mb, 6, R.sampleWeight);
                                                "ERROR" === rc ? G(mb, 2, 2) : "WARNING" === rc ? G(mb, 2, 1) : G(mb, 2, 0);
                                                var Ff = new wg;
                                                G(Ff, 1, !0);
                                                Nc(Ff, 3, xg, Rb);
                                                var nb = new sg;
                                                G(nb, 3, window.location.href);
                                                for (var Nj = N("FEXP_EXPERIMENTS", []), Gf = 0; Gf < Nj.length; Gf++) {
                                                    var Oj = nb,
                                                        En = Nj[Gf];
                                                    Ec(Oj);
                                                    Ic(Oj, 5).push(En)
                                                ...
                                                var Hf = bh();
                                                if (!ch() && Hf)
                                                    for (var Pj = u(Object.keys(Hf)), ob = Pj.next(); !ob.done; ob = Pj.next()) {
                                                        var Qj = ob.value,
                                                            If = new ug;
                                                        G(If, 1, Qj);
                                                        If.setValue(String(Hf[Qj]));
                                                        Oc(nb, 4, ug, If)
                                                    }
                                                var Jf = R.params;
                                                if (Jf) {
                                                    var Rj =
                                                        u(Object.keys(Jf));
                                                    for (ob = Rj.next(); !ob.done; ob = Rj.next()) {
                                                        var Sj = ob.value,
                                                            Kf = new ug;
                                                        G(Kf, 1, "client." + Sj);
                                                        Kf.setValue(String(Jf[Sj]));
                                                        Oc(nb, 4, ug, Kf)
                                                    }
                                                }
                                                var Tj = N("SERVER_NAME", void 0),
                                                    Uj = N("SERVER_VERSION", void 0);
                                                if (Tj && Uj) {
                                                    var Lf = new ug;
                                                    G(Lf, 1, "server.name");
                                                    Lf.setValue(Tj);
                                            ...
                                            if (dn()) Df = void 0;
                                                ...
                                                R.fileName && (sc.filename = R.fileName);
                                                var Ha = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : [];
                                                0 !== Ha.length && (1 !== Ha.length || isNaN(Number(Ha[0])) ? 2 !== Ha.length || isNaN(Number(Ha[0])) || isNaN(Number(Ha[1])) || (sc.lineNumber = Number(Ha[0]), sc.columnNumber = Number(Ha[1])) : sc.lineNumber = Number(Ha[0]));
                                                var Nf = {
                                                ...
                                                "ERROR" === rc ? Nf.level = "ERROR_LEVEL_ERROR" : "WARNING" === rc && (Nf.level = "ERROR_LEVEL_WARNNING");
                                                var Fn = {
                                                        isObfuscated: !0,
                                                        browserStackInfo: sc
                                                    },
                                                ...
                                                N("FEXP_EXPERIMENTS") && (Sb.experimentIds = N("FEXP_EXPERIMENTS"));
                                                var Of = bh();
                                                if (!ch() && Of)
                                                    for (var Xj = u(Object.keys(Of)), pb = Xj.next(); !pb.done; pb = Xj.next()) {
                                                        var Yj = pb.value;
                                                        Sb.kvPairs.push({
                                                            key: Yj,
                                                            value: String(Of[Yj])
                                                ...
                                                var Pf = R.params;
                                                if (Pf) {
                                                    var Zj = u(Object.keys(Pf));
                                                    for (pb = Zj.next(); !pb.done; pb = Zj.next()) {
                                                        var ak = pb.value;
                                                        Sb.kvPairs.push({
                                                            key: "client." + ak,
                                                            value: String(Pf[ak])
                                                ...
                                                var bk = N("SERVER_NAME", void 0),
                                                    ck = N("SERVER_VERSION", void 0);
                                                bk && ck && (Sb.kvPairs.push({
                                                    key: "server.name",
                                                    value: bk
                                                }), Sb.kvPairs.push({
                                                    key: "server.version",
                                            ...
                                            if (!dk) break a;
                                            Jm("clientError", dk)
                                        }("ERROR" === rc || P("errors_flush_gel_always_killswitch")) && zi()
                                    }
                                    if (!P("suppress_error_204_logging")) {
                                        ...
                                        tc.version && (Ua["client.version"] = tc.version);
                                        if (Ua.postParams) {
                                            qb.stack && (Ua.postParams.stack = qb.stack);
                                            for (var ek = u(Object.keys(tc)), Qf = ek.next(); !Qf.done; Qf = ek.next()) {
                                                var fk = Qf.value;
                                                Ua.postParams["client." + fk] = tc[fk]
                                            }
                                            var Rf = bh();
                                            if (Rf)
                                                for (var gk = u(Object.keys(Rf)), Sf = gk.next(); !Sf.done; Sf = gk.next()) {
                                                    var hk = Sf.value;
                                                    Ua.postParams[hk] = Rf[hk]
                                                }
                                            var ik = N("SERVER_NAME", void 0),
                                                jk = N("SERVER_VERSION", void 0);
                                            ik && jk && (Ua.postParams["server.name"] =
                                                ik, Ua.postParams["server.version"] = jk)
                                        }
                                        Xh(N("ECATCHER_REPORT_HOST", "") + "/error_204", Ua)
                                    }
                                    try {
                                        Ym.add(pa.message)
                                    } catch (Kn) {}
    ...
    m.Ia = function(a) {
        ...
        switch (b) {
            ...
            case "initialDelivery":
                Na(a) && (window.clearInterval(this.j), this.playerInfo = {}, this.M = {}, Cn(this, a.apiInterface), Bn(this, a));
                break;
            default:
                sn(this, b, a)
        }
    ...
    function Cn(a, b) {
        D(b, function(c) {
            this[c] || ("getCurrentTime" === c ? this[c] = function() {
                ...
                return d
            } : yn(c) ? this[c] = function() {
                this.playerInfo = {};
                this.M = {};
                vn(this, c, arguments);
                return this
            } : zn(c) ? this[c] = function() {
                var d = 0;
    ...
    m.getVideoEmbedCode = function() {
        var a = on(this.i, "host") + ("/embed/" + on(this.i, "videoId")),
            b = Number(on(this.i, "width")),
            c = Number(on(this.i, "height"));
        if (isNaN(b) || isNaN(c)) throw Error("Invalid width or height property");
        b = Math.floor(b);
        c = Math.floor(c);
        Eb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(yb, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(zb, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Ab, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Bb, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(Cb, "&#39;")), -1 != a.indexOf("\x00") &&
            (a = a.replace(Db, "&#0;")));
    ...
    C("YT.subscribe", function(a, b, c) {
        rf.subscribe(a, b, c);
        jn[a] = !0;
        for (var d in gn) gn.hasOwnProperty(d) && un(gn[d], a)
    });
    ...
    rn.prototype.setSize = rn.prototype.setSize;
    rn.prototype.getIframe = rn.prototype.getIframe;
    rn.prototype.addEventListener = rn.prototype.addEventListener;
    An.prototype.getVideoEmbedCode = An.prototype.getVideoEmbedCode;
    An.prototype.getOptions = An.prototype.getOptions;
    An.prototype.getOption = An.prototype.getOption;
    hn.push(function(a) {
        var b = a;
        b || (b = document);
        a = db(b.getElementsByTagName("yt:player"));
        var c = b || document;
        if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll(".yt-player");
            ...
            if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll(".yt-player");
                ...
                for (c = d = 0; b = e[c]; c++) {
                    var g = b.className,
                        h;
                    if (h = "function" == typeof g.split) h = 0 <= $a(g.split(/\s+/),
                        "yt-player");
                    h && (f[d++] = b)
                }
                f.length = d;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || kn();
    var Hn = A.onYTReady;
    Hn && Hn();
    var In = A.onYouTubeIframeAPIReady;
    In && In();
    var Jn = A.onYouTubePlayerAPIReady;
    Jn && Jn();
}).call(this);